...
const DailyRaffle = () => {
  ...
  const handleClick = () => {
    ...
    if (count === syrup?.initialcount) {
      axios
        .post(`${API_URL}/v1/users/addViewsOfWaffleCount`, {
  ...
  const adduser = () => {
    // setOpens(true)
    axios
      .post(`${API_URL}/v1/users/addUser`, { walletAddress: account })
      .then((response) => {
  ...
  const getuser = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setsyrCount(response.data.user.syrupQuantity);
  ...
  const getallwinner = () => {
    // setOpens(true)
    axios
      .get(`${API_URL}/v1/users/getAllWinner`)
      .then((response) => {
  ...
  const dsicordenterance = () => {
    // setOpens(true)
    axios
      .post(`${API_URL}/v1/users/addDiscordId`, {
        walletAddress: account,
        discordId: discordid,
        discordAdded: true,
      })
