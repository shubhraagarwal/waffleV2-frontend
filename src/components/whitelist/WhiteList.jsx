...
const WhiteList = (props) => {
  ...
  const getalldiscorddasta = () => {
    // setOpens(true)
    axios
      .get(`${API_URL}/v1/users/getAllUsers`)
      .then((response) => {
  ...
  // let now = new Date("2022,02,23T12:00:00Z")
  // let now= new Date('2022-02-23T12:00:00Z')
  // console.log("tomoroow",wintime)
  // let now= new Date('2022-02-22 6::00 PM')
  // console.log("now", now)
  // console.log("now",now)
  function timer() {
    let time = new Date();
  ...
  const submitdiscordid = () => {
    // setOpens(true)
    axios
      .post(`${API_URL}/v1/users/submitDiscordUser`, { walletAddress: account })
      .then((response) => {
